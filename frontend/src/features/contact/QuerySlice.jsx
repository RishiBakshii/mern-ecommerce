...
export const addQueryAsync=createAsyncThunk("contact/addQueryAsync",async(descMessage)=>{
    const addedQuery=await addQuery(descMessage)
    return addedQuery
})
...
const querySlice=createSlice({
    ...
    reducers:{
        ...
        clearQuerySuccessMessage:(state)=>{
            state.successMessage=null
        },
        toggleIsAddressed: (state) => {
            state.isAddressed = !state.isAddressed
        },
        resetQueryDescMessage: (state) => {
            state.descMessage = "empty"
        }
...
// exporting selectors
export const selectQueryIsAddressed=(state)=>state.QuerySlice.isAddressed
export const selectQueryDescMessage=(state)=>state.QuerySlice.descMessage
...
// exporting actions
export const {clearQuerySuccessMessage,clearQueryErrors,resetQueryDescMessage,toggleIsAddressed}=querySlice.actions
